...
*******************************************************/
package com.maxxsoft.config.stateMachine.guards;
...
@Component
public class DeliveryGuard implements Guard<OrderStates, OrderEvents> {

	@Override
	public boolean evaluate(StateContext<OrderStates, OrderEvents> context) {

		//System.out.println("I AM IN THE GUARD");
		return context.getMessageHeader(OrderServiceImpl.ORDER_ID) != null;
	}
}