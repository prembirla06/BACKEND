...
public class GiftMessage_ {
	...
	private ExtensionAttributes____________________ extensionAttributes;
	@JsonIgnore
	...
	@JsonProperty("extension_attributes")
	public ExtensionAttributes____________________ getExtensionAttributes() {
		return extensionAttributes;
	}

	@JsonProperty("extension_attributes")
	public void setExtensionAttributes(ExtensionAttributes____________________ extensionAttributes) {
