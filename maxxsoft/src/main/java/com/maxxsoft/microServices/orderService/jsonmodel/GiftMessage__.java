...
public class GiftMessage__ {
	...
	private ExtensionAttributes____________________________ extensionAttributes;
	@JsonIgnore
	...
	@JsonProperty("extension_attributes")
	public ExtensionAttributes____________________________ getExtensionAttributes() {
		return extensionAttributes;
	}

	@JsonProperty("extension_attributes")
	public void setExtensionAttributes(ExtensionAttributes____________________________ extensionAttributes) {
