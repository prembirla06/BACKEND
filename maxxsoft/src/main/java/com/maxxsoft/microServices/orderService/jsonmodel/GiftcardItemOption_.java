...
public class GiftcardItemOption_ {
	...
	private ExtensionAttributes_________________ extensionAttributes;
	@JsonIgnore
	...
	@JsonProperty("extension_attributes")
	public ExtensionAttributes_________________ getExtensionAttributes() {
		return extensionAttributes;
	}

	@JsonProperty("extension_attributes")
	public void setExtensionAttributes(ExtensionAttributes_________________ extensionAttributes) {
