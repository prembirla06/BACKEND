...
public class BillingAddress {
	...
	private ExtensionAttributes_______ extensionAttributes;
	@JsonIgnore
	...
	@JsonProperty("extension_attributes")
	public ExtensionAttributes_______ getExtensionAttributes() {
		return extensionAttributes;
	}

	@JsonProperty("extension_attributes")
	public void setExtensionAttributes(ExtensionAttributes_______ extensionAttributes) {
