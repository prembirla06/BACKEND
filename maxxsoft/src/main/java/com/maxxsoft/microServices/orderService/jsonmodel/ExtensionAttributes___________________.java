...
public class ExtensionAttributes___________________ {

	@JsonProperty("gift_message")
	private GiftMessage_ giftMessage;
	@JsonProperty("gw_id")
	private String gwId;
	...
	@JsonProperty("gift_message")
	public GiftMessage_ getGiftMessage() {
		return giftMessage;
	}

	@JsonProperty("gift_message")
	public void setGiftMessage(GiftMessage_ giftMessage) {
