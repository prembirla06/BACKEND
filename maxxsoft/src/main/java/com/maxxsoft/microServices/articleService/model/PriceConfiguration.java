...
@AllArgsConstructor
@Builder
@Table(name = "priceConfiguration", schema = "public")
public class PriceConfiguration extends AuditModel {
	...
	private int marketingCostPercentage;

	private int profitMarginPercentage;

	private BigDecimal fulfillmentCost;

	private int minimumMarkupCost;
